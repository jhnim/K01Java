...
/*
 Local variable(지역변수)
 -변수는 사용범위(Scope)를 가지고 있고, 해당지역내에서만 사용가능하다.
...
public class E06LocalVariable {
	...
	public static void main(String[] args) {
		...
		큰지역에서 이미 선언하여 메모리상에 상주하고 있기 때문이다.
		*/
		//int num = 9; //[에러발생]
		if(scope) {
			int num = 1;
		...
		/*
		 if문의 블럭에서 변수 num은 해당 블럭을 벗어나면 메모리에서 소멸된다.
	...
	/*
	 ...
	 simpleFunc()메소드는 서로 다른 지역에 정의되었으므로 이름의 변수를 선언할 수 있다.
	 */
