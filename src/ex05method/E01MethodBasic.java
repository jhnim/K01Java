...
/*
 ...
 -반환값이 없는 void형 메소드는 실행이 완료되면 호출한 위치로 실행의 흐름이 돌아온다.
 */
public class E01MethodBasic {
	
	/*
	 메소드정의1 : 반환타입ㅇ, 매개변수ㅇ, 형태로 정의
	...
	public static void main(String[] args) {
		...
		/*
		 메소드를 호출할때는 함수의 원형을 그대로 기술하면된다.
		 매개변수가 있다면 갯수만큼 포함시켜주면 된다. 매개변수의 갯수가 다르면 호출되지 않고 에러가 발생된다.
		 */
