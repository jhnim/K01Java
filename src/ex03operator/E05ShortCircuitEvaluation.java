...
public class E05ShortCircuitEvaluation {
	...
	/*
	 SCE(Short-Circuit Evaluation)
	 	:하나의 조건검사만으로 결과를 알 수 있는 경우 Java컴파일러는 뒤의 조건을 수행하지 않고 건너뛰게된다. 
	...
	public static void main(String[] args) {
		...
		/*
		 &&(논리and)의 경우 둘중 하나만 false면 false를 반환하므로 
		...
		//num2는 초기값인 0을 유지하게 된다. 만약 num2의 값이 프로그럄에 영향을 미치게 된다면 이부분은 유의해야한다.
