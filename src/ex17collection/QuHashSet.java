...
class Avengers {
	...
	public int hashCode() {
		...
		/*
		 해당 객체가 보유한 모든 멤버변수를 이용해서 해시값을 구하고 연산(사칙연산 뭐든지)하여 결과를 반환하면 된다.
		 */
		return hc1+hc2+hc3;
	}
	...
	public boolean equals(Object obj) {
		...
		if(this.heroName.equals(avengers.heroName) && this.name.equals(avengers.name) && this.weapon.equals(avengers.weapon)) {
			return true;
		}
		else {
			return false;
