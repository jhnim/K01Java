...
/*
 ...
 - Set의 기본적인 특성은 동일하나, Tree알고리즘을 통해 정렬되어 저장된다. 정렬의 기준은 개발자가 지겁 정의할 수 있다.
...
class MyString implements Comparable<MyString>{
	...
	/*
	 ...
	 아래 코드는 오름차순(작은것->큰것) 정렬일 때 사용한다. 1과 -1의 위치가 바뀌면 내림차순이 된다.
	 */
	@Override
	public int compareTo(MyString paramStr) {
		
		//정렬의 순서은 문자열의 길이를 기준으로 한다.
...
public class Ex04TreeSetMain {
	...
	public static void main(String[] args) {
		...
		//중복이 제거되어 4개만 저장됨
		System.out.println("저장된 데어터 수:"+ tree1.size());
		...
		/*
		 - 문자열의 길이가 정렬의 기준일때는 아래 객체 중 7글자인 KOSMOXX는 1개만 삽입된다.
