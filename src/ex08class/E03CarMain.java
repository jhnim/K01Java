...
class Car{
	...
	String carModel = AUTO;//모델명
	int carYear;// 연식
	Human owner;/*
		소유주: Human클래스를 기반으로 하는 멤버변수로 초기화를 위해 이름, 나이, 에너지 세가지의 값이 필요함.
		이와같이 클래스를 구성할 때 또 다른 객체를 멤버변수로 선언할 수 있다.
	*/
	...
	/*
	 ...
	 초기화를 진행하는 역할은 동일하나, 매개변수를 통해 다양한 형태의 객체를 초기화할 수 있다.
	 */
...
public class E03CarMain {
	...
	public static void main(String[] args) {
		...
		//car1.drive();
		/*
		 	에러발생(자동차 소유주를 표현하는 Human객체가 초기화되지 않은 상태에서 출력을 시도하여 런타임에러가 발생된다.)
		 */
		...
		//자동차2 객체생성 : 객체생성 후 멤버변수에 직접 접근하여 초기화한다.
		Car car2 = new Car();
