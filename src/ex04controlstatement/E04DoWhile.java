...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException{
		...
		/*
		 ...
		 단, 사용자가 X, x(대소문자 구분없음)를 입력하면 프로그램이 종료되어야 하며 do~while문으로 구현해야한다.
		 */
		...
		do {
			...
			/*
			 switch문은 if문과 같은 조건식을 사용할수 없고 산술식만 사용할 수 있으므로 점수의 구간을 구하기 위해 총점을 30으로 나눈다.
			 */
