...
//		}
		...
		/*
		 if(조건식); => 조건식에 상관없이 다음 문장이 실행되는 형태로 세미콜론은 문장의 끝을 나타내므로 사용에 주의해야한다.
		 */
		if(num%2 != 0);
		{
		...
		/*
		 System.in.read()
		 	: 사용자에게 하나의 문자를 입력받을 때 사용하는 함수(메소드)로 입력한 문자의 아스키코드값을 반환한다.
		 	해당 함수 IOException을 기본적으로 가지고 있어서 이를 무시하기위해 main()함수에서 throws처리를 해준다.
		 */
