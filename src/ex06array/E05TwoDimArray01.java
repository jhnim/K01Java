...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
 		아래와 같이 2차원배열을 초기화하면 세로3, 가로4인 배열이 생성된다. 초기화할 요소가 없는 부분은 null로 채워지게 된다.
 		※null값 : 아무것도 없는 값을 일컫는다. 즉 반값을 말한다. 스페이스와 같은 공백문자와는 다르다는 것에 주의하자.
		 */
		int[][] arr = {
				{1,2},
				{3,4,5},
		...
		/*
		 각 행의 가로크기는 초기화된 상태에 따라 다를 수 있다. 0행은 2, 2행은 4의 크기를 가지게된다.
		 */
