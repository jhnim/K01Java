...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 그래서 배열병(배열변수)는 주소값(참조값)을 할당받게된다.
		 해당주소를 통해 배열에 접근한다.
		 */
		...
		System.out.println("배열명(numArr)="+ numArr); //배열명(numArr)=[I@15db9742 => 참조값 출력
		...
		/*
		 ...
		 배열명.length : 해당 변수는 배열의 크기를 반환한다. 배열의 크기가 변경되는 경우에 유연하게 사용할 수 있다.
		 */
		int[] arrNumber = new int[40];
		 ...
		 /*
		  객체배열 (String..)
		  	: 기본자료형을 저장하는 배열이 아니라, 객체의 참조값을 저장할 용도로 생성하는 배열이다. 사용방법은 동일하다.
		  */
		 ...
		 /*
		  배열의 선언과 동시에 초기화를 하는 경우 자바 컴파일러는 초기값이 갯수를 통해 크기를 결정 할 수 있으므로 
		  이런 경우 크기는 생략하도록 약속되어있다.
		  */
		 ...
		 /*
		  배열요소의 갯수를 통해 배열을 즉시 생성한다. 이때, new키워드는 생략한다.
		  */
