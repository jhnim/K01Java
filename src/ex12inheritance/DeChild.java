...
public class DeChild extends DeParent {
	...
	/*
	 메소드 오버라이딩의 조건
	 - 부모클래스에서 선언될 때와 비교해서 접근범위가 동잏하거나 그보다 넓으면 가능하다.
	 - 즉, 부모에서 default로 선언했다면 자식에서는 default 혹은 public이면 오버라이딩이 가능하다.
	 */
	@Override
	public String sleep() {
	...
	/*
	 ...
	 클래스 외부(메소드 영역)에 존재하므로 오버라이딩 되지 않고 호출할 때는 각 클래스명을 통해 호출해야한다.
	 */
