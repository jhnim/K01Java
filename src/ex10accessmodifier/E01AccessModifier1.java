...
/*
 접근지정자를 생략했으므로 default클래스로 지정된다. 해당클래스는 동일 패키지 내에서만 접근가능하다.
 */
class DefaultClass1{
	void myFunc() {
...
/*
 public클래스는 해당 java파일을 대표하는 클래스로 파일명과 동일하고 다른패키지에서도 접근이 가능하다.
 public클래스는 하나의 자바파일에 하나만 정의할 수 있다.
 */
public class E01AccessModifier1 {

	//멤버변수를 각각의 접근 지정자를 통해 선언
