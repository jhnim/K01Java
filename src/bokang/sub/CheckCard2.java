...
public class CheckCard2 {
	...
	/*
	 생성자메소드와 멤버메소드의 유일한 차이점은 생성자는 반환값이 없고, 멤버메소드는 반환값이 있다.
	 따라서 멤버메소드응 정의할때는 반드시 void 혹은 반환타입을 명시해야한다. 
	 */
	...
	/*
	 멤버변수가 private으로 선언되면 클래스 내부에서만 접근가능하므로, 외부에서의 접근을 위해
	 getter/setter를 필수적으로 생성해야 한다.
	 */
	...
	public void savingPoint(int amount) {
		...
		this.point += plusPoint; // 복합대입연산자는 자동형변환이 됨.
	}
