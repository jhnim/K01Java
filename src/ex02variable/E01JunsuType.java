...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		- byte, short형은 게임 케릭터의 움직임의 표현이나 음원정보 등을 저장할 때 사용한다.
		 */
		...
		/*
		 - 동일자료형 끼리의 연산은 동일자료형이 되는 것이 기본 원칙임.
		...
		/*
		 	자바컴파일러(CPU)는 정수형상수를 기본적으로 int형으로 간주하기 때문에 위 정수를 메모리에 몰리는 순간 에러가 발생한다.
		 	이때는 접미사 (L 혹은 l)을 붙여서 int형 자료가 아닌 long형 자료임을 알려줘야한다.
