...
public class Qu_02_03 {
	...
	public static void main(String[] args) {
		...
		float area_float = (float)area;
		double area_double = area;
		
		System.out.println("int형 넓이:"+area_int);
		System.out.println("float형 넓이:"+(float)area_float);
		...
		- 큰 자료형을 작은 자료형에 대입할때는 자료의 손실이 있을 수 있으므로 반드시 강제형변환(명시적형변환)을 통해 형변환 후 대입해야한다.
