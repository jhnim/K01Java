...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 아래코드는 자동형변환은 아님. CPU는 int보다 작은 자료형을 int로 간주하고 연산을 진행하며, 결과도 int로 반환한다.
		 CPU의 특성이라 생각하자.
		 */
		int num1 = b1 + s1;
		int num2 = num1; //없어도 상관없음
		System.out.println("num1은 "+ num1);
		
		/*
		 char형(문자타입)에 byte형(숫자타입)을 바로 대입할 수 없다.
		 성질이 다르므로 명시적형변환 후 대입해야한다.
		 */
		//char ch1 = b1; 에러발생
		char ch2 = (char)b1;
		...
		/*
		 명시적 형변환: 큰상자의 자료를 작은상자의 자료형에 할당해야할 때 사용함.
		...
		/*
		 소수점 아래부분이 버려지므로 데이터 손실있음. 따라서 특수한 경우가 아니라면 사용을 자제해야함.
		 */
		int num3;
		double dl = 3.14;
		num3 = (int)dl;
		...
		/*
		 char과 int를 연산하면 결과는 int이므로 char형 변수에 대입하려면 명시적(강제) 형변환 후 대입해야한다.
		 */
		char ch3 = 'A', ch4;
		int num4 = 2;
