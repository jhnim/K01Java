	...
	public static void main(String[] args) {
		...
		/*
		 equals()메소드
		 	...
		 	즉 아래는 객체에 실제 저장된 문자열에 대한 비교가 이루어진다.(객체간의 내용에 대한 비교)
		 */
		if(str1.equals(str2)) {
		...
		/*
		 String 클래스의 객체생성방법 2: "(더블쿼테아션)을 사용한다.
		 	이 경우 내용이 동일하다면 같은 주소를 사용하게된다.
		 */
		String str3 = "KOSMO";
		String str4 = "KOSMO";
		...
		/*
		 자바에서 문자열 객체를 생성할 때 new를 사용하지 않고 "를 사용하면 동일한 문자열인 경우 메모리를 하나만 사용하여 공유하게 된다.
		 */
		if(str3==str4) {
