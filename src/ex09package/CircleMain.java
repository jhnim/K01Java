...
/*
 메인클래스에서 다른 패키지의 클래스를 import하려면 해당 클래스는 반드시 public으로 선언해야한다.
 그렇지않으면 "not visible" 에러가 발생한다.
 */
public class CircleMain {
	...
	public static void main(String[] args) {
		...
		//원의 둘레: import하여 해당 클래스를 문서에 포함
		Circle circle2 = new Circle(4.5);
		System.out.println("반지름이 4.5인 원의들레:"+ circle2.getPerimeter());
	}
